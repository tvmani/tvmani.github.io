...
function extractSessions(name, localStorage) {
  ...
  var sucessfulQuestions = allAttemptedQuestions.map(function (qs) {
    return qs.filter(function (q) {
      return _Evaluator2["default"].evaluateQuestion(q);
    });
  });
  var failedQuestions = allAttemptedQuestions.map(function (qs) {
    return qs.filter(function (q) {
      return !_Evaluator2["default"].evaluateQuestion(q);
    });
  });
  var failedNumbers = failedQuestions.map(function (qs) {
  ...
  var successfulNumbers = sucessfulQuestions.map(function (qs) {
    return qs.map(function (q) {
      return [q.firstNum, q.secondNum];
    });
  }).filter(function (q) {
