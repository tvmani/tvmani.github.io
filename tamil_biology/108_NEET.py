...
filename = "12th_Bio_Zoology_TM_Combined_23-03-2020_Page_270-279.xlsx"
# lessonTitle = "அலகு 5 - தாவர செயலியல் (Plant Physiology)"
lessonTitle = "12th - விலங்கியல் நீட் போட்டி தேர்வு பயிற்சி"
...
def create_slide(quizRecord, prs, isQuestion=True):
    ...
    shape = slide.shapes.add_shape(
        MSO_SHAPE.RECTANGLE, 0, Inches(0.1), Inches(10), Inches(0.3)
    )
...
QuizRecord = col.namedtuple('QuizRecord', 'question_no, question, exams_already_asked, year, option_1, \
                            option_2, option_3, option_4, option_5, correct_answer')
QuizRecordsDb = []
